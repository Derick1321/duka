...
<div class="page-banner-area page-banner-height-2" data-background="{{ asset('web/img/banner/page-banner-4.jpg')}}">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <form action="#">
                           <div class="table-content table-responsive">
                              <table class="table">
                                    ...
                                    <tbody>
                                       <tr>
                                          <td class="product-thumbnail"><a href="shop-details.html"><img src="{{ asset('web/img/cart/shop-p-10.jpg')}}" alt=""></a></td>
                                       ...
                                       <tr>
                                          <td class="product-thumbnail"><a href="shop-details.html"><img src="{{ asset('web/img/cart/shop-p-11.jpg')}}" alt=""></a></td>
                           ...
                           <div class="row justify-content-end">
                              <div class="col-md-5">
                                    <div class="cart-page-total">
                                       ...
                                       <a class="tp-btn-h1" href="/checkout">Proceed to checkout</a>
                                    </div>
                              </div>
                           </div>
                        </form>
                        ...
                        <div class="cta-item mb-30">
                            ...
                            <div class="cta-apps">
                                <div class="apps-store">
                                    <a href="#"><img src="{{ asset('web/img/brand/app_ios.png')}}" alt=""></a>
                                    <a href="#"><img src="{{ asset('web/img/brand/app_android.png')}}" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
