                    ...
                    <div class="col-xl-7">
                        <div class="swiper-container slider__active pb-30">
                            <div class="slider-wrapper swiper-wrapper">
                                <div class="single-slider swiper-slide b-radius-2 slider-height-2 d-flex align-items-center" data-background="{{asset('web/img/slider/02-slide-1.jpg')}}">
                                ...
                                <div class="single-slider swiper-slide b-radius-2 slider-height-2 d-flex align-items-center" data-background="{{asset('web/img/slider/02-slide-2.jpg')}}">
                                    <div class="slider-content slider-content-2">
                                ...
                                <div class="single-slider b-radius-2 swiper-slide slider-height-2 d-flex align-items-center" data-background="{{asset('web/img/slider/02-slide-3.jpg')}}">
                                    <div class="slider-content slider-content-2">
                    ...
                    <div class="col-xl-5">
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="banner__item p-relative w-img mb-30">
                                    <div class="banner__img b-radius-2">
                                        <a href="/product-details"><img src="{{asset('web/img/banner/banner-10.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="banner__content banner__content-2">
                                        <h6><a href="/product-details">Canyon <br> Star Raider</a></h6>
                                        <p>Headphone & Audio</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="banner__item p-relative w-img mb-30">
                                    <div class="banner__img b-radius-2">
                                        <a href="/product-details"><img src="{{asset('web/img/banner/banner-11.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="banner__content banner__content-2">
                                        <h6><a href="/product-details">Phone <br> Galaxy S20</a></h6>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="banner__item p-relative w-img mb-30">
                                    <div class="banner__img b-radius-2">
                                        <a href="/product-details"><img src="{{asset('web/img/banner/banner-13.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="banner__content banner__content-2">
                                        <h6><a href="/product-details">Galaxy <br> Buds Plus</a></h6>
                                        <p>Headphone & Audio</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="banner__item p-relative w-img mb-30">
                                    <div class="banner__img b-radius-2">
                                        <a href="/product-details"><img src="{{asset('web/img/banner/banner-12.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="banner__content banner__content-2">
                                        <h6><a href="/product-details">Chair <br>Swoon Lounge</a></h6>
                                        <p>Headphone & Audio</p>
                                    </div>
                                </div>
                            </div>
